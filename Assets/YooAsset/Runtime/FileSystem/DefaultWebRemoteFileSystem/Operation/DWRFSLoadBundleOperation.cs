    ...
    internal class DWRFSLoadAssetBundleOperation : FSLoadBundleOperation
    {
        ...
        internal override void InternalUpdate()
        {
            ...
            if (_steps == ESteps.LoadWebAssetBundle)
            {
                ...
                {
                    string mainURL = _fileSystem.RemoteServices.GetRemoteAssetURL(_bundle.FileName);
                    string fallbackURL = _fileSystem.RemoteServices.GetRemoteAssetFallbackURL(_bundle.FileName);
